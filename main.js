...
var pbvStyle = (() => {
  ...
  return '#pbvContainer .flex {display: flex;}#pbvContainer .none {display: none;}#pbvMenu {margin: 30px 0;padding: 0;}#pbvContainer .mode label {display: block;margin: auto 5px auto 0;cursor: pointer;}#pbvContainer .mode input {cursor: pointer;}#pbvContainer .aBut {display: block;margin: auto 0 auto 5px;padding: 3px 6px;border-radius: 16px;background-color: #eee;color: #666;cursor: pointer;text-align: center;text-decoration: none;}#itemList>div {width: 50%;display: inline-block;position: relative;}#itemList>div>div {display: inline-block;box-sizing: border-box;position: relative;width: 100%;vertical-align: bottom;}#itemList>div>div>a>div {width: 100%;height: 100%;position: relative;background: #fff;overflow: hidden;}#itemList>div>div>a>div>div.square {display: block;height: 0;width: 100%;padding-bottom: 100%;}#itemList>div>div>a>div>div.image {position: absolute;top: 0;left: 0;width: 100%;height: 100%;background-size: cover;}#itemList>div>div>a>div>div>div {position: absolute;top: 4px;right: 4px;display: inline-block;background: rgba(0,0,0,.4);line-height: 19px;color: #fff;padding: 0 6px;border-radius: 20px;font-size: 10px;font-weight: 700;}#itemList>div>div>a>div>div>div>img {vertical-align: middle;height: 9px;margin-right: 3px;}';
})();
var pbvNav = (() => {
