...
resolve()})}
function createDataText(data){return new Promise(function(resolve){clearLocalStorage().then(()=>{var maxLength=2000000;var pbvCount=Math.ceil(data.length/maxLength);localStorage.setItem('pbvCount',pbvCount);for(var i=0;i<pbvCount;i++){var key='pbv_'+i;var value=data.substr(i*maxLength,maxLength);localStorage.setItem(key,value)}});resolve()})}
