...
var data;try{new Promise(function(resolve,reject){data=JSON.parse(optionTextarea.value);bookmarkData=(()=>{if(data.bookmark)return data.bookmark;return[]})();userData=(()=>{if(data.user)return data.user;return{}})();resolve()}).then(saveToLocalStorage()).then(()=>{optionTextarea.value='完了'})}
...
getData(url).then(res=>{try{new Promise(function(resolve,reject){var data=JSON.parse(res);bookmarkData=(()=>{if(data.bookmark)return data.bookmark;return[]})();userData=(()=>{if(data.user)return data.user;return{}})();resolve()}).then(saveToLocalStorage()).then(()=>{optionTextarea.value='完了'})}
