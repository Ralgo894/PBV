...
nav.innerHTML=pbvNav;var navBookmark=document.getElementById('navBookmark');var navOption=document.getElementById('navOption');navBookmark.addEventListener('click',()=>{if(page=='bookmark')return;navBookmark.classList.add('active');navOption.classList.remove('active');page='bookmark';saveToLocalStorage().then(loadToLocalStorage()).then(()=>{changePage();setEvent()})},!1);navOption.addEventListener('click',()=>{if(page=='option')return;navOption.classList.add('active');navBookmark.classList.remove('active');page='option';saveToLocalStorage().then(loadToLocalStorage()).then(()=>{changePage();setEvent()})},!1)}
